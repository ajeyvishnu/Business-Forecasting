...
* Also, we can see that after 15th lad period, the ACF plot is dipping into the negative values stating seasonality also exists in the data.

## Decomposition

##### Q: Plot the decomposition of the time series.
...
##### Q: Is the decomposition additive or multiplicative? 
...
##### Q: If seasonal, what are the values of the seasonal monthly indices? 

```{r}

```

##### Q: For which month is the value of time series high and for which month is it low? 
...
##### Q: Can you think of the reason behind the value being high in those months and low in those months?
* Not very sure regarding the reasons behind.
...
##### Q: Perform Residual Analysis for this technique. 
###### Q: Do a plot of residuals. What does the plot indicate?
```{r}
...
###### Q: Do a Histogram plot of residuals. What does the plot indicate?
...
###### Q: Do a plot of fitted values vs. residuals. What does the plot indicate?
...
###### Q: Do a plot of actual values vs. residuals. What does the plot indicate?
...
###### Q: Do an ACF plot of the residuals? What does this plot indicate?
...
##### Q: Print the 5 measures of accuracy for this forecasting technique
...
##### Forecast 
###### Q: Time series value for next year. Show table and plot
...
##### Q: Summarize this forecasting technique
...
###### Q: What does it predict the value of time series will be in one year?
...
##### Q: Plot the graph for time series. 
##### Q: Show the Simple Moving average of order 3 on the plot above in Red
##### Q: Show the Simple Moving average of order 6 on the plot above in Blue
##### Q: Show the Simple Moving average of order 9 on the plot above in Green
...
##### Q: (Bonus) show the forecast of next 12 months using one of the simple average order that you feel works best for time series
```{r}
plot(forecast(mavg3_forecast), main = "Forecasting for next months using order 3")
```

* The order 3 moving average gave the most near actual values compared to order 6 and 9.
* So, I have chosen moving average of order 3.

##### Q: What are your observations of the plot as the moving average order goes up? 
...
## Simple Smoothing
##### Q: Perform a simple smoothing forecast for next 12 months for the time series. 
...
###### Q: What is the value of alpha?  What does that value signify? 
###### Q: What is the value of initial state? 
###### Q: What is the value of sigma?  What does the sigma signify?
...
## Holt-Winters 
##### Q: Perform Holt-Winters forecast for next 12 months for the time series.
...
###### Q: What is the value of alpha?  What does that value signify? 
###### Q: What is the value of beta? What does that value signify?
###### Q: What is the value of gamma? What does that value signify?
###### Q: What is the value of initial states for the level, trend and seasonality? What do these values signify? 
###### Q: What is the value of sigma?  What does the sigma signify?
...
###### Q: What does it predict the value of time series will be in one year?
* Based on HoltWinters forecast, the predicted value of the time series in one year (Aug 2018) is 322481.0.
...
## Accuracy Summary
##### Q: Show a table of all the forecast method above with their accuracy measures.
...
##### Q: Show the best and worst forecast method for the accuracy measure of your choice. Why did you choose that accuracy measure?
...
## Conclusion
##### Q: Summarize your analysis of time series value over the time-period. 
...
##### Q: Based on your analysis and forecast above, do you think the value of the time series will increase, decrease or stay flat over the next year? How about next 2 years?
